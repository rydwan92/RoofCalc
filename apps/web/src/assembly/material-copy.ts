const pl = {
  ...
  commercialReady: 'Gotowe handlowo',
  missingCompanyPrice: 'Bez ceny',
  outsideCompanyAssortment: 'Poza asortymentem',
  ...
  partial: 'CZĘŚCIOWE',
  catalogue: 'KATALOG',
  manual: 'CENA RĘCZNA DLA TEJ WYCENY',
...
const en: typeof pl = {
  ...
  missingCompanyPrice: 'Without price',
  outsideCompanyAssortment: 'Outside assortment',
  ...
  partial: 'PARTIAL',
  catalogue: 'CATALOGUE',
  manual: 'MANUAL PRICE FOR THIS ESTIMATE',
